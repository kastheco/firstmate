...
- Scope review findings to behavior directly affected by this change and in use.
  ...
  Security and data-loss findings never defer, including destructive writes, credential paths, and permanent-deletion defects on unreached paths.
  For everything else outside what the change touched, disclose a follow-up in the PR body on the successor ticket instead of spending a fix round.
