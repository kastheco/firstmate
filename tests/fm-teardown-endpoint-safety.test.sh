...
test_orca_worktree_id_accepts_orca_format_and_rejects_unsafe_values() {
  ...
  # different reason: a traversal segment, a relative path half, an empty or
  # non-opaque repo half, an embedded space, shell metacharacters, and a value
  # that smuggles a second metadata line.
  ...
  for bad in \
    ...
    '1cf44768::/home/captain/dev/my demo/fm-x' \
    '1cf44768::/home/captain/dev/demo/fm-x$(touch /tmp/fm-pwn)' \
  ...
  pass "Orca worktree id: accepts Orca's composite and plain forms, refuses traversal, relative, malformed, and whitespace-bearing values"
}
